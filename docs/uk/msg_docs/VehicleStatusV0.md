...
uint8 NAVIGATION_STATE_ROCKET_ASCENT = 7    # Rocket ascent mode
uint8 NAVIGATION_STATE_ROCKET_COAST = 8     # Rocket coast mode
uint8 NAVIGATION_STATE_ROCKET_PGNAV = 9     # Rocket powered guidance navigation
